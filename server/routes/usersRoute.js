...
router.get("/get-all-hospitals", authMiddleware, async (req, res) => {
  try {
    ...
    return res.send({
      success: true,
      messgae: "Hospitals fetched successfully",
      data: hospitals,
    });
  } catch (error) {
    return res.send({
...
//get all unique organizations for donar
router.get("/get-all-organizations-of-a-donar", authMiddleware, async (req, res) => {
  try {
    ...
    return res.send({
      success: true,
      messgae: "Organizations fetched successfully",
      data: hospitals,
    });
  } catch (error) {
    return res.send({
...
//get all unique organizations for hospital
